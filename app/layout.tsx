...
export const metadata: Metadata = {
  ...
  description: "A little reminder of how much I love you and appreciate everything you do for us. - Yours, Jitin",
  openGraph: {
    title: "Hey gorgeous...",
      ...
      <body className="min-h-full flex flex-col relative">
        ...
        <div className="fixed bottom-4 right-6 sm:bottom-6 sm:right-8 z-50 pointer-events-none opacity-40 mix-blend-screen">
          <p className="text-[10px] sm:text-xs tracking-[0.3em] text-white/50 uppercase font-sans">
            Jitin & Yu <span className="text-rose-500 animate-pulse inline-block ml-1">❤</span>
          </p>
        </div>
      </body>
    </html>
